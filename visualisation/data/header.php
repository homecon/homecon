...
-->
		...
		<div id='header' data-role='header' data-position='fixed' data-tap-toggle='false' data-theme='b'>
			<nav>
				<a href='index.php' data-ajax='false' id='home'><img src='icons/ffffff/control_building_empty.png'></a>
				<a href='#' id='menu_button'><img src='icons/ffffff/control_bars.png'></a>
				<div class='home'>
					<a class='hide' href='#home_users'><img src='icons/ffffff/edit_settings.png'></a>
					...
					<a href='index.php?logout=1' data-ajax='false'><img src='icons/ffffff/control_logout.png'></a>
				</div>	
				<div class='pagebuilder'>
					<a class='publish' href='#'><img src='icons/ffffff/edit_save.png'></a>
