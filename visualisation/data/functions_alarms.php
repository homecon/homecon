	...
	while($row = mysql_fetch_array($result)){
		...
		echo "
				<script>
					$('#$id_time').change(
						function(){
							$.post( 'data/set_alarm.php', {'id': $id , 'column': 'time' , 'value': $(this).val()}); 
							//for debugging: 
							//$.post( 'data/set_alarm.php', {'id': $id , 'column': 'time' , 'value': $(this).val()}, function(response){alert(response);}); 
						}
					);
					$('#$id_mon').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'mon', 'value': $(this).is(':checked')});
						}
					);
					$('#$id_tue').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'tue', 'value': $(this).is(':checked')});
						}
					);
					$('#$id_wed').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'wed', 'value': $(this).is(':checked')});
						}
					);
					$('#$id_thu').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'thu', 'value': $(this).is(':checked')});
						}
					);
					$('#$id_fri').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'fri', 'value': $(this).is(':checked')});
						}
					);
					$('#$id_sat').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'sat', 'value': $(this).is(':checked')});
						}
					);
					$('#$id_sun').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'sun', 'value': $(this).is(':checked')});
						}
					);
					$('#$iditemselect').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'item', 'value': $(this).val()});
						}
					);
					$('#$idactionselect').change(
						function(){
							$.post( 'data/set_alarm.php', { 'id': $id , 'column': 'action', 'value': $(this).val()});
						}
					);
				</script>
			</div>";
